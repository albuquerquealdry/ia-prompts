...
3. Criação de texto usando as referências e palavras. Testar a compreenção do texto com perguntas. Ou exercício de vídeo no youtube com perguntas no final.
4. Explicação curta (gramática, expressão, função)
5. Exercício guiado
6. Produção livre
...
* Selecione palavras que estão disponíveis prioritariamente na tabela words.pdf mas também escolha umas dos demais livros, só não diga quais palavras do words.pdf iremos praticar, nem deixe em negrito faça ser um texto natural mesmo.
* Use como base para criar os textos os livros que anexei(Sofias World and OS), foque em textos do nível B2.
...
* Faça 2 perguntas sobre o texto focado em extrair o nível da minha compreenção.
